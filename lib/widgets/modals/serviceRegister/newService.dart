...
class NewServiceModal extends StatelessWidget {
  final Function()? onServiceAdded;
  final int id;

  const NewServiceModal({Key? key, this.onServiceAdded, required this.id})
      : super(key: key);
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  if (nameController.text.isNotEmpty &&
                    ...
                    DatabaseHelper().insertService(newService).then((id) {
