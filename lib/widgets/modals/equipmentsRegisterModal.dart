...
class EquipmentsRegisterModal extends StatelessWidget {
  final Function()? onEquipmentAdded;

  const EquipmentsRegisterModal({Key? key, this.onEquipmentAdded})
      : super(key: key);
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  if (nameController.text.isNotEmpty &&
                    ...
                    DatabaseHelper().insertEquipment(newEquipment).then((id) {
